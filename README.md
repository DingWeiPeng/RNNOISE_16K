...
./dump_features -rir_list rir_list.txt speech.pcm background_noise.pcm foreground_noise.pcm features.f32 <count>, where count is the number of sequences to process. The number of sequences should be at least 10,000, but more is better (200,000 or more is recommended).
